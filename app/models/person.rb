  ...
  def male?
    if self.gender == 'u'
      ...
      [
        'Abel', 'Abraham',
        'Adam', 'Adolf', 'Adolphus',
        'Alan', 'Albert', 'Alexander', 'Alex', 'Alfredo', 'Alfred', 'Alf', 'Allen', 'Alphonse',
        'Anatole', 'Andrew', 'Angus', 'Antoine', 'Antonio', 'Anton',
        'Archibald', 'Archie', 'Arnold', 'Arthur',
        'Augustus',
        'Barry',
        'Benjamin', 'Ben', 'Bernard',
        'Bill',
        'Bob', 'Boris',
        'Brian', 'Bryan',
        ...
        'Felice', 'Felix',
        'Filippo',
        'Francesco', 'Frank', 'Fraser', 'Frederic', 'Frederick', 'Fred',
        'Gaetano', 'Gary', 'Gavin',
        'George', 'Georges', 'Gerard',
        'Giacomo', 'Giovanni', 'Gilbert',
        ...
        'Lorenzo', 'Louis',
        'Luciano', 'Luigi',
        'Marcel', 'Marco', 'Maurice', 'Martin', 'Matthew', 'Matt',
        'Michael', 'Michel', 'Mick',
        'Montague', 'Montgomery',
        'Murray',
        'Nathan',
        ...
        'Philip', 'Philippe',
        'Pierre', 'Pietro',
        'Raffaello', 'Raymond', 'Ray',
        'Rees', 'Reginald', 'Reg', 'Reggie',
        'Richard',
        'Robert', 'Roger', 'Roland', 'Rory', 'Ross', 'Rowland',
        'Russell', 'Russ',
        'Samuel',
        'Sebastian',
        'Sergey',
  ...
  def female?
    if self.gender == 'u'
      ...
      [
        ...
        'Georgia', 'Georgina', 'Gerda', 'Gertrud',
        'Gladys',
        'Grace', 'Greta', 'Grete',
        'Hanna', 'Hattie', 'Hazel',
