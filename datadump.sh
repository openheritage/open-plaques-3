...
curl http://0.0.0.0:3000/places/gb/areas/london/subjects.csv > db/open-plaques-subjects-london-$(date +'%Y-%m-%d').csv
curl http://0.0.0.0:3000/places/gb/subjects.csv > db/open-plaques-subjects-united-kingdom-$(date +'%Y-%m-%d').csv
curl http://0.0.0.0:3000/subjects.csv > db/open-plaques-subjects-all-$(date +'%Y-%m-%d').csv
...
curl http://0.0.0.0:3000/plaques.json?limit=200000000 > db/open-plaques-all-$(date +'%Y-%m-%d').json
...
curl http://0.0.0.0:3000/plaques.geojson?limit=200000000 > db/open-plaques-all-$(date +'%Y-%m-%d').geojson
